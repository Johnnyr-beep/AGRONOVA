...
export class MainLayoutComponent {
  ...
  menuItems = [
    ...
    { label: 'Cavas', icon: 'pi pi-th-large', route: '/cavas' },
    { label: 'Embalajes', icon: 'pi pi-box', route: '/embalajes' },
    { label: 'Devoluciones', icon: 'pi pi-replay', route: '/devoluciones' },
    { label: 'Pieles', icon: 'pi pi-tag', route: '/pieles' },
    { label: 'Insumos', icon: 'pi pi-shopping-cart', route: '/insumos' },
    { label: 'Movimientos', icon: 'pi pi-arrows-h', route: '/movimientos' },
    { label: 'Traslados', icon: 'pi pi-send', route: '/traslados' },
    { label: 'Liquidaciones', icon: 'pi pi-dollar', route: '/liquidaciones' },
    { label: 'Auditorías', icon: 'pi pi-history', route: '/auditorias' },
